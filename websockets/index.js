...
export default (io) => {
  ...
  io.listen("scan-websites/upload", async (fileBuffer) => {
    ...
    const book = service.addSheetToXlsxBook(
      null,
      "Website Scans",
      columns,
      rows
    ...
    const filePath = "./output/" + fileName + ".xlsx";
    service.writeXlsxFile(book, filePath);
